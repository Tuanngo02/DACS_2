...
<?php if(isset($_POST['thanhtoanck'])&& ($_POST['thanhtoanck'])){
    ...
    values($user_id,'$fullname','$email','$phone','$address','$note','$oder_date','Đã thanh toán')";
...
<div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Ngày đặt:</span> Oct 12, 2019</div>
<div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Trạng thái:</span> <span class="badge badge-warning badge-pill px-25">Unpaid</span></div>
</div>
</div>
